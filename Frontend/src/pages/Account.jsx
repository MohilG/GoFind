...
My Bookings</Link>
            <Link  className={subpage==='places'?'bg-primary text-white rounded-full py-2 inline-flex gap-1 px-6 ':'bg-gray-200 rounded-full py-2 inline-flex gap-1 px-6 '} to={'/account/places'}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
