...
<span className='font-bold text-xl'>Go Find</span>
</Link>
<div className="flex gap-2 shadow-md shadow-gray-500 border rounded-full py-2 px-4 border-gray-300">
<div>Anywhere</div>
...
<div className="flex items-center gap-2 shadow-md shadow-gray-500 border rounded-full py-2 px-4 border-gray-300">
